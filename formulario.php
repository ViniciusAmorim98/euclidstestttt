...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['nome']) && isset($_POST['whatsapp']) && isset($_POST['email'])) {
        ...
        try {
            ...
            $mail->addAddress('marcosvinicius.sep98@gmail.com'); // Insira o primeiro e-mail de destino
            $mail->addAddress('marcosvinicius.nunesamorim@gmail.com'); // Insira o segundo e-mail de destino
